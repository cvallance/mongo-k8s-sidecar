...
| MONGODB_USERNAME | NO | | Configures the mongo username for authorization |
| MONGODB_PASSWORD | NO | | Configures the mongo password for authorization |
| MONGODB_DATABASE | NO | local | Configures the mongo database |
